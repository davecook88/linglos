...
def index():
	...
	if form.validate_on_submit():
		word = form.word.data.lower().strip()
		...
		if db_word is None:
			try:
				...
				flash('Word being added to database. Add to list later.')
